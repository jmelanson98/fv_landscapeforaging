...
#############################################################
## Load in results from colony and get sibship assignments
#############################################################
# set probability threshold, colony output filenames, specimen datasets
prob_thresh = 0.995
filenamemix22 = "colony_assignments/Colony2_Linux/mixtus2022.FullSibDyad"
filenamemix23 = "colony_assignments/Colony2_Linux/mixtus2023.FullSibDyad"
...
genotyped2022 = specsubset[specsubset$barcode_id %in% mixtus2022_forcolony$barcode_id,]
genotyped2023 = specsubset[specsubset$barcode_id %in% mixtus2023_forcolony$barcode_id,]


# get sibships
mixsibs2022 = filterSibships(filename = filenamemix22,
                             prob_thresh = prob_thresh,
                             specdata = genotyped2022)
mixsibs2023 = filterSibships(filename = filenamemix23,
                             prob_thresh = prob_thresh,
                             specdata = genotyped2023)

write.csv(mixsibs2022, "data/siblingships/mixtus_sibships_2022.csv")
write.csv(mixsibs2023, "data/siblingships/mixtus_sibships_2023.csv")
