...
fq = readRDS("simulate_data/landscapes/random_field_range10/landscape_001.rds")
fq = terra::rast(fq)

##### Load in landscape metrics #####
config = readRDS("simulate_data/landscapes/random_field_range400/landscape_001.rds")
...
result = readRDS("simulate_data/foraging_distance/methods_comparison/landscape_effects/colony-centric/simdata.rds")
...
# Run models locally with rstan and look at some results
# for running in rstan (no reduce sum)
